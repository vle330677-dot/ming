  ...
  return (
    <div className="absolute inset-0 bg-slate-900 overflow-hidden font-sans select-none text-slate-300">
      ...
      <div className="absolute top-8 left-8 z-50">
        <button 
          onClick={onExit} 
          className="bg-slate-900/90 text-cyan-400 border border-cyan-800 px-6 py-2 rounded font-bold shadow-[0_0_15px_rgba(6,182,212,0.3)] flex items-center gap-2 hover:bg-cyan-900/30 transition-all"
        >
